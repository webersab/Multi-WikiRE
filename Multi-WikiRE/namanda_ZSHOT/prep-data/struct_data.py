...
fname = 'data/datasets/newsqa/NewsQA-train-v1.1.json'
fnamedev = 'data/datasets/newsqa/NewsQA-dev-v1.1.json'
fnametest = 'data/datasets/newsqa/NewsQA-test-v1.1.json'
